---
title: Symposium Day 1 (30 July 2026)
...
<div>
	<b>Download the <a href="/files/SCRI_E_Booklet_Online.pdf">Event E-Booklet</a>.</b>
		<br><br>
</div>

<div>
  <b>30 July 2026 (Thu) | 08:00 - 16:30</b>&nbsp;
  <h3>Programme</h3>
</div>
                ...
                <hr class="my-3 border-primary">
                  ...
                  <div style="display: flex;flex-wrap:wrap;" class="row">
                    <div class="col iprog-speaker">
                      <div class="row">
                        <div class="col is-7 is-5-mobile">
                          <a rel="noopener" class="speaker-name text-ellipsis" href="/janise-chevrier-lee/"><img src="/images/JaniseChevrierLee.png" class="speaker-image mb-4"></a>
												</div></div>
                        <div class="col">
                          <div class="speaker-name text-ellipsis">
                            <a rel="noopener" class="speaker-name text-ellipsis" href="/janise-chevrier-lee/">
                              <b>Dr Janise Chevrier-Lee</b></a>
                          </div>
                          <div class="text-ellipsis speaker-position">Country Medical Head, Singapore</div>
...
<div class="text-ellipsis speaker-company">Novartis Foundation</div>
                  ...
                  <div style="display: flex;flex-wrap:wrap;" class="row">
                    <div class="col iprog-speaker">
                      <div class="row">
                        <div class="col is-7 is-5-mobile">
                          <a rel="noopener" class="speaker-name text-ellipsis" href="/li-yang-hsu/"><img src="/images/HsuLiYang.png" class="speaker-image mb-4"></a>
												</div></div>
                        <div class="col">
                          <div class="speaker-name text-ellipsis">
                            <a rel="noopener" class="speaker-name text-ellipsis" href="/li-yang-hsu/">
                              <b>Prof Li Yang Hsu</b></a>
                          </div>
                          <div class="text-ellipsis speaker-position">Professor, Saw Swee Hock School of Public Health</div>
<div class="text-ellipsis speaker-company">National University of Singapore</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="speakers px-2">
                  <div style="display: flex;flex-wrap:wrap;" class="row">
                    <div class="col iprog-speaker">
                      <div class="row">
                        <div class="col is-7 is-5-mobile">
                          <a rel="noopener" class="speaker-name text-ellipsis" href="/fook-kay-lee/"><img alt="Fook Kay Lee" src="/images/FookKayLee.png" class="speaker-image mb-4"></a>
												</div></div>
                        <div class="col">
                          <div class="speaker-name text-ellipsis">
                            <a rel="noopener" class="speaker-name text-ellipsis" href="/fook-kay-lee/">
