          ...
          <div class="col is-12">
            <div class="border bg-light h-100 position-relative">
              <div class="p-4 bg-different">
                ...
                "Lessons Learned and Best Practices – Adaptive Trial Design"</h4>
                <hr class="my-3 border-primary">
          ...
          <div class="col is-12">
            <div class="border bg-light h-100 position-relative">
              <div class="p-4 bg-different">
                ...
                <h4 class="programme-title">Parallel Track 6: Exploring Clinical Trial Trends Across Nations<br>
                "Unveiling Diverse Clinical Trial Landscapes Across Nations"
</h4>
                <hr class="my-3 border-primary">
								3 Speakers x 15 mins each<br>
Panel Discussion x 45 mins
          ...
          <div class="col is-12">
            <div class="border bg-light h-100 position-relative">
              <div class="p-4 bg-different">
                ...
                (Speakers to be Proposed by Sponsor)
</h4>
                <hr class="my-3 border-primary">
								3 Speakers x 15 mins each<br>
Panel Discussion x 45 mins
          ...
          <div class="col is-12">
            <div class="border bg-light h-100 position-relative">
              <div class="p-4">
                ...
                "Emerging Regulatory Trends: Provide Insights Into Current and Anticipated Changes in Regulations Affecting Clinical Trials"</h4>
                <hr class="my-3 border-primary">
								3 Speakers x 15 mins each<br>
Panel Discussion x 45 mins
              </div>
            ...
            <div class="border bg-light h-100 position-relative">
              <div class="p-4">
                ...
                <h4 class="programme-title">
                  Closing Address<br>"Future of Clinical Trials in Singapore"
                </h4>
                <hr class="my-3 border-primary">
  ...
  <div class="row">
    <div class="col is-12">
      <div class="border bg-light h-100 position-relative">
        <div class="p-4">
          <div class="programme-time">
            <b>31 Jul | 00:00 - 00:00</b>&nbsp;<b>GMT+8</b>
          </div>
          <h4 class="programme-title">PlaceHolder Title</h4>
          <hr class="my-3 border-primary">
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
...
<style type="text/css">
  ...
  .bp-container.is-fluid {
	...
	.bg-notice { background-color: #EDEDEC; }
</style>