          ...
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">
                    <a href="/blank/"><img alt="Yeo Khung Keong" src="/images/Speakers_Blank.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
                      <a rel="noopener" class="speaker-name text-ellipsis" href="/blank/"><b>Prof Yeo Khung Keong</b></a>
                    </div>
                    <div class="text-ellipsis speaker-position">
                      Chief Executive Officer &amp; Senior Consultant</div>
                    <div class="text-ellipsis speaker-company">National Heart Centre Singapore
                    </div>
                  </div>
                </div>
              </div>
