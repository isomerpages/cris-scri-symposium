          ...
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">
                    <img alt="Daphne Gardner Tan" src="/images/Speakers_Blank.png" class="speaker-image mb-4">
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
                      <a rel="noopener" class="speaker-name text-ellipsis"><b>Dr Daphne Gardner Tan</b></a>
                    </div>
                    <div class="text-ellipsis speaker-position">
          ...
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">
                    <a><img alt="David Tan" src="/images/Speakers_Blank.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
                      <a rel="noopener" class="speaker-name text-ellipsis"><b>A/Prof David Tan</b></a>
                    </div>
                    <div class="text-ellipsis speaker-position">
          ...
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">
                    <a><img alt="Ai Ling Sim-Devadas" src="/images/Speakers_Blank.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
                      <a rel="noopener" class="speaker-name text-ellipsis"><b>Ms Ai Ling Sim-Devadas</b></a>
                    </div>
                    <div class="text-ellipsis speaker-position">
                      Deputy Director (Advocacy and Engagement)
                    </div>
                    <div class="text-ellipsis speaker-company">LKC Medicine </div>
                  </div>
                </div>
              </div>
              <div class="col is-6 prog-speaker">
