          ...
          <div class="col is-12">
            <div class="border bg-light h-100 position-relative">
              <div class="p-4 bg-different">
                ...
                (Theme and Speakers to be Proposed by Sponsor)
</h4>
                <hr class="my-3 border-primary">
								3 Speakers x 15 mins each<br>
Panel Discussion x 45 mins
...
<br>“Role of Patient Advocacy Group, Community Involvement and Collaboration in Advancing Clinical Research”</h4>
                <hr class="my-3 border-primary">
								3 Speakers x 15 mins each<br>
Panel Discussion x 45 mins
              </div>
...
<br>(Speakers to be Proposed by Sponsor)</h4>
                <hr class="my-3 border-primary">
								3 Speakers x 15 mins each<br>
Panel Discussion x 45 mins
              </div>
...
<style type="text/css">
  ...
  .bp-container.is-fluid {
	...
	.bg-different { background-color: #C9F3F6; }
</style>