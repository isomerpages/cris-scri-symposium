...
<a href="/david-matchar/"><img alt="David Matchar" src="/images/Speakers_DavidMatchar.png" class="speaker-image mb-4"></a>
          ...
          <div class="speaker-company text-ellipsis">Health Services and Systems Signature Research Programme</div>
              ...
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">
                    <a><img alt="Oh Choon Hong" src="/images/Speakers_Blank.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
                      <a rel="noopener" class="speaker-name text-ellipsis"><b>Adj Asst Prof Oh Choon Hong</b></a>
                    </div>
                    <div class="text-ellipsis speaker-position">
                     Deputy Director, Changi General Hospital</div>
                    <div class="text-ellipsis speaker-company">Adjunct Assistant Professor, Duke-NUS Medical School</div>
                  </div>
                </div>
              </div>
            </div>
