              ...
              <div class="p-4">
                <div class="programme-time">
                  <b>30 Jul | 10:00 - 10:30</b>&nbsp;
								                ...
								                <h4 class="programme-title">Introduction of Keynote Speaker 1</h4>
                <hr class="my-3 border-primary">
                <div class="speakers px-2">
                  <div class="row">
                    <div class="col is-6 prog-speaker">
                ...
                <div class="speakers px-2">
                  <div class="row">
                    <div class="col is-6 prog-speaker">
                      <div class="row">
                        <div class="col is-4">
                          <a rel="noopener" class="speaker-name text-ellipsis" href="/jeremy-farrar/"><img alt="jeremy farrar" src="/images/Speakers_Blank.png" class="speaker-image mb-4">
                          </a>
                        </div>
                        <div class="col is-12">
                          <div class="speaker-name text-ellipsis">
        ...
        <div class="p-4 bg-light">
                ...
                <div class="row">
                  ...
                  <div class="col is-8">
                    ...
                    <div class="text-ellipsis speaker-company">Deputy Executive Director, Programme for Research in Epidemic Preparedness and Response (PREPARE)</div>
										                    <div class="text-ellipsis speaker-company">Professor, Lee Kong Chian School of Medicine, NTU &amp; NUS Yong Loo Lin School of Medicine</div>
										                                      </div>
                </div>
              </div>
              <div class="col is-6 prog-speaker">
          ...
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4"><a href="/david-tan/"><img alt="David Tan" src="/images/Speakers_DavidTan.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
        ...
        <div class="p-4 bg-different">
          ...
          <div class="speakers px-2">
            <div class="row">
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">						                    <a href="/david-matchar/"><img alt="David Matchar" src="/images/Speakers_DavidMatchar.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
          ...
          <div class="speaker-company text-ellipsis">Health Services and Systems Signature Research Programme</div>
              ...
              <div class="col is-6 prog-speaker">
                <div class="row">
                  <div class="col is-4">
										<a href="/kelvin-bryan-tan/"><img alt="Kelvin Bryan Tan" src="/images/Speakers_Blank.png" class="speaker-image mb-4"></a>
                  </div>
                  <div class="col is-8">
                    <div class="speaker-name text-ellipsis">
                      <a rel="noopener" class="speaker-name text-ellipsis" href="/kelvin-bryan-tan/"><b>A/Prof Kelvin Bryan Tan</b></a>
                    </div>
                    <div class="text-ellipsis speaker-position">
                      Principal Health Economist Chief 
                    </div>
                    <div class="text-ellipsis speaker-company">Health Economist's Office, Ministry of Health (MOH)</div>
                   </div>
                </div>
              </div>
            </div>
...
<section>
  <div class="bp-container is-fluid">
	...
	<p>*Please note that the programme may be subject to change without prior notice.<br>Tracks 1-10 will be a 45-min presentation by speakers followed by 45-min panel discussion. </p>
</section>
