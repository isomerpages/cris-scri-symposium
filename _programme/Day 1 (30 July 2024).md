          ...
          <div class="col is-12">
            <div class="border bg-light h-100 position-relative">
              <div class="p-4 bg-different">
                ...
                <h4 class="programme-title">Track 4: Decentralised Clinical Trials </h4>
                <hr class="my-3 border-primary">
								This track will be powered by conference valued partners.<br><br>
