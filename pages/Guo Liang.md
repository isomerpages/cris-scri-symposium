...
Over the years in SCRI, she has collaborated extensively with partners across diverse healthcare and policy domains. Her work includes scientific review, protocol development, methodological consultation, providing analytical support to multidisciplinary research teams. She has contributed to the production of high-quality academic outputs and has published multiple articles in peer reviewed journals. Recently she has increasingly focused on health technology assessment (HTA) and support evidence-informed policy and reimbursement decisions. She is actively involved in policy aligned projects, contributing to HTA application reviews, the generation of fit for purpose evidence, economic evaluations, and the development of value dossiers to inform healthcare funding and policy considerations.
</p>
</div>
</div>